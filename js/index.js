...
var data = [{
	...
	},
	{
		...
		body: [{
			...
			{
				tag: 'p',
				content: '在中天新聞網跑社會線期間，因為文筆好、工作認真，被三立新聞網主管注意到，被挖角到三立新聞網編輯中心當小夜主管，即使不用在外面跑新聞，我仍在公司狂發稿追新聞，彌補小夜人力之不足，發稿量和新聞流量，在主管群中名列前茅，獲得主管肯定。'
			}
		],
	},
	{
		...
		body: [{
			...
			{
				tag: 'p',
				content: '為了彌補兒時沒念復興美工的遺憾，輔大碩士畢業2年後，又到復興商工美工科夜間部學畫畫，熱心服務的我獲選班代，每學期名列前茅拿獎學金，並通過人像速寫中階檢定，畢業展5幅作品入選，在美麗永安藝術中心展出，獲局長獎和教師會表揚。'
			}
		],
	},
];
