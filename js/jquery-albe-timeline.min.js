...
! function (e) {
  e.fn.albeTimeline = function (t, n) {
    ...
    if ("string" == typeof t && (t = e.parseJSON(t)), e.isEmptyObject(t)) console.warn(s.msgEmptyContent);
    else {
      t = t.sort(function (e, a) {
        return r.sortDesc ? Date.parse(a.time) - Date.parse(e.time) : Date.parse(e.time) - Date.parse(a.time)
      });
      var i = e("<ul>").attr("id", "timeline-menu"),
        l = e("<section>").attr("id", "timeline");
      e.each(t, function (t, n) {
        var d = new Date(n.time).getUTCFullYear(),
          o = e(l).find("div.group" + d);
        if (0 === o.length) {
      ...
      var d = e("<div>").addClass("badge").html("&nbsp;"),
        o = e("<div>").addClass("panel").append(d);
      l.append(e("<article>").append(o)), l.append(e("<div>").addClass("clearfix").css({
        float: "none"
      })), e.each(l.find("article"), function (a, t) {
